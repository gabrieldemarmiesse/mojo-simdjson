...
struct TapeWriter:
    ...
    fn append_s64(mut self, value: Int64):
        self.append2(0, value.cast[DType.uint64](), tape_type.INT64)

    fn append_u64(mut self, value: UInt64):
    ...
    fn skip_large_integer(mut self):
        self.next_tape_loc += 2

    fn skip_double(mut self):
        self.next_tape_loc += 2

    fn append(mut self, value: UInt64, value_type: TapeType):
        self.next_tape_loc[] = value | (value_type.cast[DType.uint64]() << 56)
        self.next_tape_loc += 1

    # TODO: add a parameter?
    fn append2(mut self, value: UInt64, value2: UInt64, value_type: TapeType):
